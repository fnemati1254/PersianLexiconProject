...
const MEASURE_INFO = {
  ...
  H_GPC_OVC_word:      "آنتروپی GPC در چارچوب OVC (آغاز–واکه–کدا) / GPC entropy of the vowel within its Onset-Vowel-Coda context.",
  H_PGC_OVC_word:      "آنتروپی PGC در چارچوب OVC / PGC entropy of the vowel within its OVC context.",

  OUF:    "عدم قطعیت آوایی رو به جلو (Westbury 2021): میانگین آنتروپی پیشوندها / Orthographic Uncertainty Forward: mean entropy of all orthographic prefixes.",
